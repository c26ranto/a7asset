...
class _$CustomErrorImpl implements _CustomError {
  const _$CustomErrorImpl({this.errorMessage = "", this.errorCode = 500});
  ...
  @override
  String toString() {
    return 'CustomError(errorMessage: $errorMessage, errorCode: $errorCode)';
  }
...
abstract class _CustomError implements CustomError {
  const factory _CustomError({final String errorMessage, final int errorCode}) =
      _$CustomErrorImpl;
